                ...
                {role === "admin" && (
                  <FormModal
                    ...
                    data={{
                      ...
                      bloodType: "A+",
                      birthday: new Date(Date.UTC(2005, 0, 1)),
                      sex: "male",
                      img: new File(
                        [],
      ...
      <div className="flex w-full flex-col gap-4 xl:w-1/3">
        <div className="rounded-md bg-white p-4">
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-xs text-gray-500">
            <Link className="rounded-md bg-sky-light p-3" href="/">
              Student&apos;s Lessons
            </Link>
            <Link className="rounded-md bg-purple-light p-3" href="/">
              Student&apos;s Teachers
            </Link>
            ...
            <Link className="rounded-md bg-yellow-light p-3" href="/">
              Student&apos;s Results
            </Link>
          </div>
        </div>
